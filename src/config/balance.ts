...
export const ENEMY_CONFIG = { maxHealth: 40, movementSpeed: 75, contactDamage: 10, experience: 3, maxActive: 240 };
export const ENEMY_VARIANTS = {
  ...
  necromancerWraith: { maxHealth: 150, movementSpeed: 0, contactDamage: 0, experience: 8, experienceDrops: 3, soulCooldownMs: 2200 },
  apparitionWraith: { maxHealth: 35, movementSpeed: 150, contactDamage: 10, experience: 4 },
  superSkeleton: { maxHealth: 800, movementSpeed: 35, contactDamage: 50, experience: 25 },
  finalBoss: { maxHealth: 5000, movementSpeed: 35, contactDamage: 0, experience: 0 }
};
